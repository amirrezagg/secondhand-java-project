 ...
 *
 * Exposes endpoints for retrieving the hierarchical category tree and performing
 * administrative lifecycle operations such as creation, update, and deletion.
 */
@RestController
